...
import Chappan from "../utils/Projects/Chappan.png";
import AOS from "aos";
...
types of delicious meals at one place on affordable prices
with great taste and feel of heaven.
                  </Text>
                </Box>
                <Box
                  py="1%"
                ...
                >
                  ...
                  <Box cursor={"pointer"} rounded="50%">
                    <Link
                      ...
                      href="https://github.com/Hariom70890/chappan"
                      target={"_blank"}
                    >
                      <Button
                        bg={"none"}
              ...
              <Box pl="2%" w={{ lg: "50%", md: "100%" }}>
                ...
                <Box py="1%">
                  ...
                  >
                    ...
                    collaborative apps. Customize your workflow, collaborate,
              ...
              <Box pl="2%" w={{ lg: "50%", md: "100%" }}>
                ...
                <Box py="1%">
                  <Text
                    ...
                    textColor={"lightgrey"}
                  >
                    Our e-commerce website boasts an intuitive and user-friendly
                    design, ensuring that visitors can easily navigate and find
              ...
              <Box pl="2%" w={{ lg: "50%", md: "100%" }}>
                ...
                <Box py="1%">
                  <Text
                    ...
                    textColor={"lightgrey"}
                  >
                    BigPocket leading online shop selling a wide range of
              ...
              <Box pl="2%" w={{ lg: "50%", md: "100%" }}>
                ...
                <Box py="1%">
                  <Text
                    ...
                    textColor={"lightgrey"}
                  >
                    ApnaTime app provides real-time tracking capabilities,
                    offering insights into how time is being spent throughout
                    the day.
                  </Text>
                </Box>
                <Box
              ...
              <Box pl="2%" w={{ lg: "50%", md: "100%" }}>
                ...
                <Box py="1%">
                  <Text
                    ...
                    className="project-description"
                  >
                    Connect with your perfect furry companion and empower animal
                    welfare organizations with our Pet Adoption Website,
                    featuring pet searches, user accounts, wish lists, adoption
